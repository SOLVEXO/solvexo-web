...
import { Tag as TagIcon, Mail, ShoppingCart, Handshake, Gift, Megaphone, Building2, User, Image as ImageIcon, Pause, Play, Trash2, Plus, Star, Bell, ArrowUp, ArrowDown, Rocket, X, type LucideIcon } from 'lucide-react';
...
type Tab = 'banners' | 'featured' | 'announcement' | 'promotions' | 'coupons' | 'platform' | 'email' | 'cart' | 'affiliate' | 'giftcards';
