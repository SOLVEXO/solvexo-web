              ...
              {PRODUCTS.map((p, i) => {
                ...
                return (
                  ...
                  >
                    ...
                    <div className="h-[5px] bg-bone rounded-[3px] overflow-hidden">
            ...
            <div className="bg-white border border-bone rounded-[10px] shadow-[0_1px_4px_rgba(0,0,0,0.04)] px-5 py-[18px]">
              <div className="flex items-start justify-between gap-4">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <p className="text-[15px] font-bold text-carbon mb-1">{selected.name}</p>
              ...
              <div className="flex flex-col gap-[14px]">
                ...
                <div>
                  <div className="flex justify-between items-center mb-[5px]">
                    <label className="text-xs font-medium text-graphite">SEO Title</label>
