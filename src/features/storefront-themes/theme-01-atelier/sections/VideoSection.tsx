...
registerAtelierSection('video', (section: Section) => {
    ...
    <div style={{ padding: `${t.layout.sectionPadY} ${t.layout.containerPadX}` }}>
      <div className="mx-auto flex flex-col gap-6" style={{ maxWidth: t.layout.maxWidth }}>
        {section.settings.heading && (
          <h2 style={{ fontFamily: t.fonts.display, fontSize: 'clamp(24px, 3vw, 34px)', fontWeight: 600, color: t.colors.ink, textAlign: 'center' }}>
            {section.settings.heading}
          </h2>
        )}
        <div style={{ aspectRatio: ASPECT[section.settings.aspectRatio] ?? '16/9', background: t.colors.bgAlt }}>
