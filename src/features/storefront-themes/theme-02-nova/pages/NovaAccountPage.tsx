      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 gap-2.5" style={{ marginBottom: '36px' }}>
        {[
          ...
          <Link
            ...
            style={{ border: `1.5px solid ${t.colors.border}`, borderRadius: t.radius.md, padding: '14px 16px' }}
          >
            <span className="flex items-center gap-2.5">
              <link.icon size={15} style={{ color: t.colors.accent }} />
              <span style={{ fontFamily: t.fonts.body, fontSize: '13px', fontWeight: 600, color: t.colors.ink }}>{link.label}</span>
            </span>
