...
export const ENDPOINTS = {
  ...
  INVENTORY: {
    ...
    REORDER_SUGGESTIONS: (storeId: string) => `/api/inventory/${storeId}/reorder-suggestions`,
    VALUATION: (storeId: string) => `/api/inventory/${storeId}/valuation`,
    EXPORT_CSV: (storeId: string) => `/api/inventory/export/${storeId}`,
    IMPORT_STOCK_CSV: (storeId: string) => `/api/inventory/${storeId}/import-stock-csv`,
  ...
  STOCK_COUNTS: {
    START: (storeId: string) => `/api/stock-counts/${storeId}/start`,
    LIST: (storeId: string) => `/api/stock-counts/${storeId}`,
    GET: (storeId: string, id: string) => `/api/stock-counts/${storeId}/${id}`,
    SUBMIT_ITEM: (storeId: string, id: string, itemId: string) => `/api/stock-counts/${storeId}/${id}/items/${itemId}`,
    CANCEL: (storeId: string, id: string) => `/api/stock-counts/${storeId}/${id}/cancel`,
    FINISH: (storeId: string, id: string) => `/api/stock-counts/${storeId}/${id}/finish`,
  },

  PURCHASE_ORDERS: {
    CREATE_SUPPLIER: (storeId: string) => `/api/purchase-orders/${storeId}/suppliers`,
    LIST_SUPPLIERS: (storeId: string) => `/api/purchase-orders/${storeId}/suppliers`,
    UPDATE_SUPPLIER: (storeId: string, supplierId: string) => `/api/purchase-orders/${storeId}/suppliers/${supplierId}`,
    ARCHIVE_SUPPLIER: (storeId: string, supplierId: string) => `/api/purchase-orders/${storeId}/suppliers/${supplierId}`,
    CREATE: (storeId: string) => `/api/purchase-orders/${storeId}`,
    LIST: (storeId: string) => `/api/purchase-orders/${storeId}`,
    GET: (storeId: string, id: string) => `/api/purchase-orders/${storeId}/${id}`,
    UPDATE: (storeId: string, id: string) => `/api/purchase-orders/${storeId}/${id}`,
    MARK_ORDERED: (storeId: string, id: string) => `/api/purchase-orders/${storeId}/${id}/mark-ordered`,
    CANCEL: (storeId: string, id: string) => `/api/purchase-orders/${storeId}/${id}/cancel`,
    CLOSE_SHORT: (storeId: string, id: string) => `/api/purchase-orders/${storeId}/${id}/close-short`,
    RECEIVE: (storeId: string, id: string) => `/api/purchase-orders/${storeId}/${id}/receive`,
  },
